...
router.get('/publisher/create', publisherController.createGet)
router.post('/publisher/create', publisherController.createPost)
router.get('/publisher/:id', publisherController.detail)
